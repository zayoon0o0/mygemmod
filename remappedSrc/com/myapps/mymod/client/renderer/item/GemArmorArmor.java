	...
	public static void clientLoad() {
		MymodModArmorModels.ARMOR_MODELS.put(MymodModItems.GEM_ARMOR_HELMET, new MymodModArmorModels.ArmorModel() {
			...
			public Identifier getArmorTexture(ItemStack stack, EquipmentModel.LayerType type, EquipmentModel.Layer layer, Identifier _default) {
				return Identifier.of("mymod:textures/models/armor/ruby_layer_1.png");
			}
		});
		...
		MymodModArmorModels.ARMOR_MODELS.put(MymodModItems.GEM_ARMOR_LEGGINGS, new MymodModArmorModels.ArmorModel() {
			@Override
			public Identifier getArmorTexture(ItemStack stack, EquipmentModel.LayerType type, EquipmentModel.Layer layer, Identifier _default) {
				return Identifier.of("mymod:textures/models/armor/ruby_layer_2.png");
			}
		});
